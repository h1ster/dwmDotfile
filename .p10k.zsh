# Generated by Powerlevel10k configuration wizard on 2026-04-27 at 15:38 MSK.
...
() {
  ...
  # 1. Меняем саму тильду на иконку
  typeset -g POWERLEVEL9K_DIR_HOME_SYMBOL=''
  #
  # # 2. Убираем текстовое сокращение, которое рисует ~ принудительно
  typeset -g POWERLEVEL9K_DIR_SHORTEN_STRATEGY=none
  #
  # # 3. Хак для Classic: если p10k видит тильду в тексте, подменяем её визуально
  typeset -g POWERLEVEL9K_DIR_CONTENT_EXPANSION='${P9K_CONTENT/\~/}'
  #
  # # 4. Чтобы иконка не была слишком мелкой и серой
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BOLD=true
